...
export const metadata = {
  title: "Brand Assets",
  description:
    "Download official Adab Real Estate Agency logos, icons, colors, and brand guidelines.",
};
...
export default function BrandPage() {
  return (
    <main>
      <PageHeader
        title="Brand Assets"
        description="Official logos, colors, and downloadable files for staff and partners."
      />

      <div className="bg-adab-cream">
        <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-6 rounded-2xl border border-adab-gray-300/60 bg-white p-6 sm:flex-row sm:items-center sm:justify-between sm:p-8">
            <div>
              <h2 className="font-[family-name:var(--font-display)] text-xl font-bold text-adab-navy-800">
                Complete brand kit
              </h2>
              <p className="mt-2 max-w-xl text-sm text-adab-gray-500">
                Download all logos, icons, social images, and color reference in
                one ZIP archive.
              </p>
            </div>
            <a
      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <section className="mb-14">
          <h2 className="mb-6 font-[family-name:var(--font-display)] text-lg font-bold text-adab-navy-800">
            Brand colors
          </h2>
          ...
          <p className="mt-4 text-sm text-adab-gray-500">
            Fonts: <strong className="text-adab-navy-800">Plus Jakarta Sans</strong>{" "}
            (display), <strong className="text-adab-navy-800">Inter</strong> (body)
          </p>
        </section>
        ...
        <p className="mt-12 text-center text-sm text-adab-gray-500">
          Questions about brand usage?{" "}
          <Link
            href="/contact"
            className="font-medium text-adab-navy-800 underline-offset-2 hover:underline"
          >
