      ...
      <div className="site-container flex h-16 items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="hidden rounded-full bg-adab-gold-500 px-4 py-2 text-sm font-semibold text-adab-navy-900 transition-colors hover:bg-adab-gold-400 phone:inline-flex"
          >
            WhatsApp
          </a>
          <Link
